...
- **卷纲是驱动引擎**：主导驱动力决定整卷节奏、冲突阶梯决定幕序、信息差弧线决定信息流动；卷纲字段与幕纲/章纲/Prompt 的字段链对齐（冲突阶梯→conflict_development、信息差弧线→start/end_state→characters→人物发动机、承诺清单→promises→reader_effect）。
