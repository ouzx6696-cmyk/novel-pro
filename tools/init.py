...
REQUIRED_SOURCE_FILES = (
    ...
    Path("templates/.agent/run-log.yaml"),
...
def deploy_project_files(project_path, genre, project_name):
    ...
    write_if_missing(
        ...
        template_text("settings/foreshadowing.md"),
    )
    write_if_missing(
        project_path / "settings/timeline.md",
        template_text("settings/timeline.md"),
    )
    ...
    write_if_missing(project_path / ".agent/run-log.yaml", template_text(".agent/run-log.yaml"))
