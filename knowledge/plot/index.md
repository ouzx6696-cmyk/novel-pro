...
| 当前问题 | 读取 |
|---|---|
| 双方都在行动但冲突不成立 | `conflict.md` |
| 章节结束后没有继续读的理由 | `hooks.md` |
| 情绪只有单向升高或没有落差 | `emotional-pull.md` |
| 需要改变读者对既有事实的理解 | `reversals.md` |
| 重大失去没有后劲 | `tragedy.md` |
| 首章迟迟没有进入故事 | `opening.md` |
...
| 需要切换不同人物视角、双线叙事、视角信息差 | `multi-pov.md` |
| 一卷结束准备下一卷、卷间状态不连贯 | `cross-volume.md` |
| 幕与幕之间衔接生硬、节奏不换挡、期待丢失 | `act-transition.md` |
